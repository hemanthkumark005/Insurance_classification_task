...
def train_and_evaluate(args):
    ...
    if args.job_dir.startswith('gs://'):
        classification_model.save(CENSUS_MODEL)
        copy_file_to_gcs(args.job_dir, CENSUS_MODEL)
    else:
        classification_model.save(os.path.join(args.job_dir, CENSUS_MODEL))

    # Convert the Keras model to TensorFlow SavedModel.
    model.to_savedmodel(classification_model, os.path.join(args.job_dir, 'export'))
